...
//  Initual Freq.= 31.25KHz (TM0,TM2)16bit暏?ゆ256鶼? @8MHz
//___________________________________________________________________
...
{	/*
	...
	_tm0al = 0x0C;				//CCRAゑ耕砞竚16bits
	_tm0ah = 0x00;
	_tm0rp = 0x01;				//CCRPΤ16bit ht66f317/ht66f318
	...
	*/
	...
	_tm1al = 0x0C;				//CCRAゑ耕砞竚10bits
	_tm1ah = 0x00;
	_tm1rpl = 0x30;				//CCRPΤ10bit ht66f317/ht66f318
	_tm1rph = 0x00;				//CCRPHΤ2bit ht66f317/ht66f318
	...
	_tm2al = 0x0C;				//CCRAゑ耕砞竚16bits
	_tm2ah = 0x00;
	_tm2rp = 0x01;				//CCRPΤ16bit ht66f317/ht66f318
...
{	
    ...
    /*
    //続TM0 TM2 PWM output period(ゲ斗琌256计, duty 50% (31.25K繵瞯)
   	wPWMPeriod = 1*256;	//	31.25K(程е)
    //wPWMPeriod = 3*256;	//	10.4KHz
    //wPWMPeriod = 255*256;	//	122.55Hz(程篊)
    wPWMDuty = 1*256/2;	//
